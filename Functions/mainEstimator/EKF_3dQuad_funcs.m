    ...
    methods (Static)
      ...
      function calcProcessModel(integ, g, T_imu2rq)
        %CALCPROCESSMODEL Generates process model and jacobian functions using symbolic toolbox
            ...
            matlabFunction(F_star_16el, 'File', strcat('Functions/mainEstimator/ekf/ekf_F_16el_', integ), 'Vars', {symbols_16}, 'Optimize', true);
            matlabFunction(L_star_16el, 'File', strcat('Functions/mainEstimator/ekf/ekf_L_16el_', integ), 'Vars', {symbols_16}, 'Optimize', true);
            matlabFunction(x_new_16el, 'File', strcat('Functions/mainEstimator/ekf/ekf_processModel_16el_', integ), 'Vars', {symbols_16}, 'Optimize', true);
            ...
            % generate and save functions
            matlabFunction(F_star_10el, 'File', strcat('Functions/mainEstimator/ekf/ekf_F_10el_', integ), 'Vars', {symbols_10}, 'Optimize', true);
            matlabFunction(L_star_10el, 'File', strcat('Functions/mainEstimator/ekf/ekf_L_10el_', integ), 'Vars', {symbols_10},'Optimize', true);
            matlabFunction(x_new_10el, 'File', strcat('Functions/mainEstimator/ekf/ekf_processModel_10el_', integ), 'Vars', {symbols_10}, 'Optimize', true);
      ...
      function calcMeasurementModel(T_rc2rq)
            ...
            % generate and save functions
            matlabFunction(measModel_10el, 'File', strcat('Functions/mainEstimator/ekf/ekf_measModel_10el'), 'Vars', {symbols_10}, 'Optimize', true);
            matlabFunction(measModel_16el, 'File', strcat('Functions/mainEstimator/ekf/ekf_measModel_16el'), 'Vars', {symbols_16}, 'Optimize', true);
            matlabFunction(H_star_10el, 'File', strcat('Functions/mainEstimator/ekf/ekf_H_10el'), 'Vars', {symbols_10}, 'Optimize', true);
            matlabFunction(H_star_16el, 'File', strcat('Functions/mainEstimator/ekf/ekf_H_16el'), 'Vars', {symbols_16}, 'Optimize', true);
