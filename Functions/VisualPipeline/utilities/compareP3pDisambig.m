    ...
    featMap = load('C:/Users/Alyssa/Documents/QuadStateEstimator/Resources/featureMap_real.mat');
    srcFile = fullfile("C:\Users\Alyssa\OneDrive - University of Cape Town\Thesis\TestsAndResults\Diss1\physical\testImgsForP3PDebug");
    T_rq2rc =  [   0  -1        0    0.0271; ...
            1.0000    0         0    0;...
            0         0    1.0000    0.0929; ...
            0         0         0    1.0000];
    ...
    for i=1:totalFrames
        ...
        if ~isnan(x_det(1,1))
            ...
            for n=1:size(Rt_arr, 3)
                pq_arr(:,n) = p3pFuncs.rtToPose(Rt_arr(:,:,n));
                pq_arr_quad(:,n)=p3pFuncs.tformPQRight(pq_arr(:,n), invertT(T_rq2rc));
            end 
    ...
    trajErr = evaluateTrackingPerformance(pose_best(:,idx_validP3p), pose_true(:,idx_validP3p), 'none');
    figure;
